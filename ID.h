...
extern int x[], locked[], pc_lock, pc;
    ...
    void decode_all() {
        switch (type) {
            ...
            case S:
                ...
                break;
            case B:
                imm = tools::get(ins, 31, 31) << 12 | tools::get(ins, 30, 25) << 5 | tools::get(ins, 11, 8) << 1 |
                      tools::get(ins, 7, 7) << 11;
                rs2 = tools::get(ins, 24, 20);
                rs1 = tools::get(ins, 19, 15);
                func3 = tools::get(ins, 14, 12);
                break;
            case U:
                ...
                break;
            case J:
                imm = tools::get(ins, 31, 31) << 20 | tools::get(ins, 30, 21) << 1 | tools::get(ins, 20, 20) << 11 |
                      tools::get(ins, 19, 12) << 12;
                rd = tools::get(ins, 11, 7);
                break;
            default:
